var categories_23 = {"A1": [ new ol.style.Style({
...
"C2": [ new ol.style.Style({
                    ...
                    var styleCache_23={}
                    var style_23 = function(feature, resolution){
                        var value = feature.get("CODIGO");
                        var style = categories_23[value];
                        var labelText = "";
                        var key = value + "_" + labelText

                        if (!styleCache_23[key]){
                            ...
                            styleCache_23[key] = new ol.style.Style({"text": text});
                        }
                        var allStyles = [styleCache_23[key]];
