var categories_21 = {"A1": [ new ol.style.Style({
...
"C1": [ new ol.style.Style({
                    ...
                    var styleCache_21={}
                    var style_21 = function(feature, resolution){
                        var value = feature.get("CODIGO");
                        var style = categories_21[value];
                        var labelText = "";
                        var key = value + "_" + labelText

                        if (!styleCache_21[key]){
                            ...
                            styleCache_21[key] = new ol.style.Style({"text": text});
                        }
                        var allStyles = [styleCache_21[key]];
